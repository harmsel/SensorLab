...
void setup() {
  ...
  accelemeter.powerOn();  // Zet de accelemeter aan, noodzakelijke code
}
void loop() {

  // -- Code voor het uitlezen van  afstandsensor
  ...
  Serial.print("x: ");
  Serial.println(x);  //stuur de waarde van x naar de serial monitor
  ...
  if (x < 20 && x > -20) {  // mijn fles staat redelijk recht als x tussen -20 en 20 zit, zijn jouw waarden anders als de fles recht staat, pas de waardes gerust aan
